 ...
 * @license    http://www.gnu.org/licenses/agpl-3.0.txt   GNU Affero General Public License v3
 */
class QFrame_Maintenance {
  
  /**
   * Singleton instance
   * @var QFrame_Maintenance
   */
  ...
  public static function instance() {
    if(self::$instance === null) self::$instance = new QFrame_Maintenance;
  ...
  public function __set($property, $value) {
    $GLOBALS['qframe_maintenance'][$property] = $value;
  }
  ...
  public function __get($property) {
    ...
    if(!isset($GLOBALS['qframe_maintenance']) || !isset($GLOBALS['qframe_maintenance'][$property]))
      return $this->defaults[$property];
      
    return $GLOBALS['qframe_maintenance'][$property];
  }
  ...
  public function isMaintenanceModeOn() {
     if ($GLOBALS['qframe_maintenance']['maintenance'] === true) return true;
