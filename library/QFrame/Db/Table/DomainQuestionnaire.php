 ...
 * @license    http://www.gnu.org/licenses/agpl-3.0.txt   GNU Affero General Public License v3
 */
class QFrame_Db_Table_DomainQuestionnaire extends QFrame_Db_Table {

  protected $_name = 'domain_questionnaire';
  protected $_primary = array('domainID', 'questionnaireID');
