 ...
 * @license    http://www.gnu.org/licenses/   GNU General Public License v3
 */
class RegQ_View implements Zend_View_Interface {
   ...
   */
  public function setHelperPath($path, $prefix = 'RegQ_View_Helper') {
   ...
   */
  public function addHelperPath($path, $prefix = 'RegQ_View_Helper') {
