...
-- Author:  Evan Bauer
/*
 * This file is part of the CSI QFrame project.
 *
 * CSI QFrame is free software; you can redistribute it and/or modify
...
--     xmlSchemaLocation added to the questionnaire table to document the source
...
--     Project name changed from RegQ to QFrame.
...
create table questionnaire (
  ...
  questionnaireVersion varchar(20),
